...
class PsicologoVirtualView extends StatefulWidget {
  const PsicologoVirtualView({super.key});

  static const routeName = '/psicologo_virtual';

  @override
  State<PsicologoVirtualView> createState() => _PsicologoVirtualViewState();
}

class _PsicologoVirtualViewState extends State<PsicologoVirtualView> {
